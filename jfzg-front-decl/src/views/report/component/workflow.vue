<template>
  <div v-if="showWorkFlow" class="workflow flow">
    ...
    <srStacetrack
      ...
      ref="track"
    >
      <!-- v-if="$route.query.processId && buttonList[0].showForm" -->
    </srStacetrack>
  </div>
</template>
...
import srStacetrack from "@/views/report/component/srStacetrack.vue";
  ...
  methods: {
    ...
    getTraceTrack() {
      ...
      this.srtracetrackRequest.getTraceTrackList(
        {
          busiId: this.busiId,
          busiType: this.$route.query.contractId
            ? "PROJECT_WEEKLY_REPORT_SONCOMMENT"
            : "PROJECT_WEEKLY_REPORT_COMMENT",
...
::v-deep .sr-trace-track .dialog-content {
