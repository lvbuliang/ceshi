...
export function removeList(params) {
  return request({
    ...
    // http://172.20.19.160:81/jfzg/projectlibrary/JHXMK/project/removeNew/project?projectId=8478
    url: `/jfzg/projectlibrary/JHXMK/project/removeNew/project?projectId=${params.projectId}&selectType=${params.selectType}`,
    method: "get",
    // params,
  });
}
...
// /jfzg/gateway/jfzg/projectlibrary/execution/addOrUpdateDelivery

export function newuploadTemporarily(data) {
  return request({
    url: `/jfzg/projectlibrary/execution/addOrUpdateDelivery`,
    method: "post",
    data,
  });
}
...
// 根据标段查询标段下的交付物
export function searchDataBysection1(data) {
  return request({
    url: `/jfzg/projectlibrary/projectProcurement/queryDeliveryList`,
    method: "post",
    data,
  });
}
...
// 根据标段查询标段下的补充信息
export function searchDataBysection2(data) {
  return request({
    url: `/jfzg/projectlibrary/projectProcurement/queryReplenishmentInfoList`,
    method: "post",
    data,
  });
}
...
// 根据里程碑查询标段信息
export function searchSectionInfo(data) {
  return request({
    url: `/jfzg/projectlibrary/projectProcurement/querySectionList`,
    method: "post",
    data,
  });
}
...
// 根据标段查询标段下的补充信息付款信息
export function searchSectionPaymentInfo(data) {
  return request({
    url: `/jfzg/projectlibrary/projectProcurement/queryProjectPayPoint`,
    method: "post",
    data,
  });
}
...
// 查取多标段接口 POST
export function getQueryCondition(data) {
  return request({
    url: `/jfzg/projectlibrary/projectStart/queryMileList`,
    method: "POST",
    data,
  });
}
...
export function getQueryMilestone(data) {
  return request({
    url: `/jfzg/projectlibrary/projectStart/queryDeliveryList`,
    method: "POST",
    data,
  });
}
...
export function getQueryMilestoneSupplemental(data) {
  return request({
    url: `/jfzg/projectlibrary/projectStart/queryReplenishmentInfoList`,
    method: "POST",
    data,
  });
}
