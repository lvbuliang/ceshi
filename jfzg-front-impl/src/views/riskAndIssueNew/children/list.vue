    ...
    <div class="issue">
      <div ref="searchRef">
        <SrSearch
          ...
          :showTextBtns="true"
          :hideBtns="false"
          @queryList="pageChanged(1, 'search')"
          class="SrSearch"
        >
          <template slot="searchBtn">
            <div class="allExport">
              <el-collapse
                v-model="activeNames"
                v-if="checkCodeInArr('M005_0020_001')"
                class="oneExport"
              >
              ...
              >
                <el-collapse-item name="0">
                  ...
                  <div>
                    <el-button
                      @click="exportProblemsTwo"
                      :disabled="exportBtn.allProblemBtn"
                      >导出问题</el-button
                    >
                  </div>
                  <div>
                    <el-button
                      @click="exportRisksTwo"
                      :disabled="exportBtn.allRiskBtn"
                      >导出风险</el-button
                    >
                  </div>
                </el-collapse-item>
        ...
        <template slot="systemName" slot-scope="{ scope }">
          <div v-if="scope.item.prop == 'systemName'">
            <div
              ...
              v-if="scope.row.contractVos && scope.row.contractVos.length > 1"
            >
              <!-- + - 按钮 -->
