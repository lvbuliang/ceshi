        ...
        >
            <div class="uploader-file-info">
                <div class="file-name">
                    ...
                    <!-- <i class="el-icon-paperclip" v-else-if="status == 'success'"></i> -->
                    <i class="el-icon-success" v-else-if="status == 'success'"></i>

                    <span class="name">{{file.name || file.fileName}}</span>
                </div>
                <div class="operate" style="line-height: initial">
                    <i class="el-icon-video-pause" v-if="status == 'uploading'" @click="pause"></i>
                    <i class="el-icon-video-play" v-else-if="status == 'paused'" @click="resume"></i>
                    <i class="el-icon-refresh-right" v-else-if="status == 'error'" @click="retry"></i>
                    <i class="el-icon-close" @click="remove"></i>
                </div>
            </div>
            <div class="progress">
                <el-progress :percentage="percentage" status="exception" color="#FF0000" v-if="status == 'error'"></el-progress>
                <el-progress :percentage="percentage" status="success" color="#009900" v-else-if="status == 'success'"></el-progress>
                <el-progress :percentage="percentage" color="#007AFF" v-else></el-progress>
            </div>
        </slot>
    </div>
</template>
