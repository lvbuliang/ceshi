<template> 
    <div class='center_echart'>
        <div class='show_echart'>
            <div class="echart" id="echart-line4" :style="{width: '80px', height: '80px'}"></div>
        </div> 
        <div class="tishi">
                <div>
      ...
      initChart(xData) {
          ...
          if(xData.length>0){
              for(var i =0;i<xData.length;i++){
                  ...
                  if(xData[i].name =='高度'){
                      this.tejidata = xData[i].quantity||0
                      this.person_teji = xData[i].percent
                  }
                  if(xData[i].name =='中度'){
                      this.jinjidata = xData[i].quantity||0
                      this.person_jinji = xData[i].percent
                  }
                  if(xData[i].name =='轻度'){
                      this.yibandata = xData[i].quantity ||0
          ...
          let getchart = echarts.init(document.getElementById('echart-line4'));
