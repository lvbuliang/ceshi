    ...
    <div class="total-page">
      <el-tabs v-if="flag" v-model="activeName" @click="handleClick">
        <template v-if="jibenxinxislotList && jibenxinxislotList.length">
          <el-tab-pane v-for="(item, i) in jibenxinxislotList" :label="item" :name="item" :key="item + i">
            <template slot="label" class="tabsLabel">
              <img
                ...
                alt
              />
              <span style="color: #333; vertical-align: middle; padding-left: 4px">{{ item }}</span>
            </template>
            <slot :name="item"></slot>
          </el-tab-pane>
          ...
          >
            <template v-if="item.title" slot="label" class="tabsLabel">
              <img
                ...
                alt
              />
              <span style="color: #333; vertical-align: middle; padding-left: 4px">{{ item.title }}</span>
            </template>
        ...
        <el-timeline class='mgt28'>
          <el-timeline-item
            ...
            <span class='imgUrl_class_title' v-if='item1.title'>{{item1.title}}</span>
            <SrView
                v-if="item1.selectData.formView"
                :formData="item1.selectData.formView.config"
                :ruleForm="item1.selectData.formView.data"
          ...
          <el-tab-pane v-for="(item, i) in otherslotList" :label="item" :name="item" :key="item + i">
            <template slot="label" class="tabsLabel">
              <img
                style="vertical-align: middle"
                src="./../assets/barrage_fill@2x.png"
